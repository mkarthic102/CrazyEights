...
public class Hand extends CardCollection {
   ...
   public Card discard(int i) {
      ...
      // storing the removed Card in a new Card object
      Card removedCard = this.cards[i];
      
      // decreasing the number of Card objects in the Hand by one
      this.numFilled--;
      
      // shifting the cards to the low-index end of the array
